...
func (d SwaggerHtmlData) DownloadData() error {
	...
	decodeString, err := base64.RawStdEncoding.DecodeString(Favicon16x16Png)
	if err != nil {
		return err
	}
	...
	decodeString, err = base64.RawStdEncoding.DecodeString(Favicon32x32Png)
	if err != nil {
		return err
	}
